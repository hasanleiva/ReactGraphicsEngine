            ...
            >
                ...
                {!selectedLayerIds.includes('ROOT') && userRole !== 'user' && (
                    <Fragment>
                        ...
                        />
                        <ContextMenuItem
                            name={t('contextMenu.duplicate', 'Duplicate')}
                            icon={<DuplicateIcon />}
                            shortcut={'Ctrl+D'}
                ...
                {!selectedLayerIds.includes('ROOT') && userRole !== 'user' && (
                    <Fragment>
                        ...
                        />
                        <ContextMenuItem name={t('contextMenu.layer', 'Layer')} icon={<LayersIcon />}>
                            <SubMenu
                                transform={{
                                    x: openMenu.clientX + offset.x,
                                    y: openMenu.clientY + offset.y,
                            ...
                            >
                                <ContextMenuItem
                                    name={t('contextMenu.bringForward', 'Bring Forward')}
                                ...
                                />
                                <ContextMenuItem
                                    name={t('contextMenu.bringToFront', 'Bring to Front')}
                                ...
                                />
                                <ContextMenuItem
                                    name={t('contextMenu.sendBackward', 'Send Backward')}
                                ...
                                />
                                <ContextMenuItem
                                    name={t('contextMenu.sendToBack', 'Send to Back')}
                                    icon={<SendToBackIcon />}
                                    shortcut={'Ctrl+Alt+['}
                                    disabled={backwardDisabled}
                        ...
                        <ContextMenuItem name={t('contextMenu.align', 'Align')} icon={<AlignLeftIcon />}>
                            ...
                            >
                                <ContextMenuItem
                                    name={t('contextMenu.alignLeft', 'Left')}
                                    icon={<AlignLeftIcon />}
                                    onClick={() => handleAlign('left')}
                                />
                                <ContextMenuItem
                                    name={t('contextMenu.alignCenter', 'Center')}
                                    icon={<AlignCenterHorizontalIcon />}
                                    onClick={() => handleAlign('center')}
                                />
                                <ContextMenuItem
                                    name={t('contextMenu.alignRight', 'Right')}
                                    icon={<AlignRightIcon />}
                                    onClick={() => handleAlign('right')}
                                />
                                <ContextMenuItem
                                    name={t('contextMenu.alignTop', 'Top')}
                                    icon={<AlignTopIcon />}
                                    onClick={() => handleAlign('top')}
                                />
                                <ContextMenuItem
                                    name={t('contextMenu.alignMiddle', 'Middle')}
                                    icon={<AlignCenterVerticalIcon />}
                                    onClick={() => handleAlign('middle')}
                                />
                                <ContextMenuItem
                                    name={t('contextMenu.alignBottom', 'Bottom')}
                ...
                {selectedLayerIds.length === 1 &&
                    ...
                    (rootLayer?.data.props as RootLayerProps)?.image && userRole !== 'user' && (
                        <ContextMenuItem
